...
- [Extensions](/effect-gql/guides/extensions) - Add custom metadata to responses
- [Middleware](/effect-gql/guides/middleware) - Wrap resolvers with cross-cutting concerns
- [Server Integration](/effect-gql/guides/server-integration) - Deploy your GraphQL server
