...
- [Middleware](/effect-gql/guides/middleware) - Per-resolver wrapping for cross-cutting concerns
- [Error Handling](/effect-gql/guides/error-handling) - Handle errors in extensions
- [Server Integration](/effect-gql/guides/server-integration) - Run your server with extensions
