...
- [Resolvers](/effect-gql/guides/resolvers) - Writing resolver functions
- [Error Handling](/effect-gql/guides/error-handling) - Handle context errors
- [Server Integration](/effect-gql/guides/server-integration) - Set up service layers
