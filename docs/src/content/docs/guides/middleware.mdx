...
- [Extensions](/effect-gql/guides/extensions) - Request lifecycle hooks for tracing and metadata
- [Error Handling](/effect-gql/guides/error-handling) - Handle errors in middleware
- [Directives](/effect-gql/guides/schema-builder#custom-directives) - Per-field transformations
