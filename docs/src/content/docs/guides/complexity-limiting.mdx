...
- [Error Handling](/effect-graphql/guides/error-handling) - Custom error responses
- [Subscriptions](/effect-graphql/guides/subscriptions) - Real-time data with WebSockets
- [Server Integration](/effect-graphql/guides/server-integration) - Platform-specific setup
