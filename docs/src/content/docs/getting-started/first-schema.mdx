...
- Learn about [Effect-based resolvers](/effect-graphql-prototype/guides/resolvers/) and service injection
- Handle errors with [structured error types](/effect-graphql-prototype/guides/error-handling/)
- Explore the [Schema Builder API](/effect-graphql-prototype/guides/schema-builder/) in depth
