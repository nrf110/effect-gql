...
- Learn about [Effect-based resolvers](/effect-gql/guides/resolvers/) and service injection
- Handle errors with [structured error types](/effect-gql/guides/error-handling/)
- Explore the [Schema Builder API](/effect-gql/guides/schema-builder/) in depth
