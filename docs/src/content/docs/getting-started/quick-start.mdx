...
- Learn about the [Schema Builder](/effect-gql/guides/schema-builder/) in detail
- Understand how [Resolvers](/effect-gql/guides/resolvers/) work with services
- Handle errors with [Structured Errors](/effect-gql/guides/error-handling/)
