...
- Learn about the [Schema Builder](/effect-graphql-prototype/guides/schema-builder/) in detail
- Understand how [Resolvers](/effect-graphql-prototype/guides/resolvers/) work with services
- Handle errors with [Structured Errors](/effect-graphql-prototype/guides/error-handling/)
