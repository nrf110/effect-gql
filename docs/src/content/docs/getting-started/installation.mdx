...
Now that you have Effect GraphQL installed, continue to the [Quick Start](/effect-graphql-prototype/getting-started/quick-start/) guide to build your first API.
